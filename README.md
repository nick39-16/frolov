Вот пошаговая инструкция по созданию GUI-приложения **«Weather Diary»** на Python с использованием библиотеки **Tkinter**. Приложение будет поддерживать добавление, просмотр, фильтрацию записей, сохранение в **JSON** и работу с **Git**.
...
WeatherDiary/
│
├── diary_app.py          # Основной файл приложения
...
## 3. Основной код приложения (`diary_app.py`)
...
Приложение для ведения дневника погоды. Позволяет добавлять записи о погоде с указанием даты, температуры, описания и наличия осадков. Реализована фильтрация по дате и температуре. Все данные сохраняются в файл JSON.
...
- Добавьте запись: укажите дату (календарь), температуру (число), описание (текст), отметьте осадки.
...
git remote add origin https://github.com/yourname/WeatherDiary.git
git push -u origin master
```

---

Если потребуется доработать интерфейс или добавить новые функции — обращайтесь!
